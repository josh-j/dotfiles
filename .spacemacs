...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; first three are spaceline themes. `dnormaloom' is the doom-emacs mode-line.
...
before packages are loaded."
  ...
  (global-set-key (kbd "<f5>") 'projectile-configure-project)
